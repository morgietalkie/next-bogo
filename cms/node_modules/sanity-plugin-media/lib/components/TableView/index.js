...
var TableViewItem_1 = __importDefault(require("../TableViewItem"));
...
var innerElementType = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Box_1.default, { alignItems: "center", bg: "darkestGray", color: "lighterGray", display: ['none', 'grid'], gridColumnGap: 2, gridTemplateColumns: "tableLarge", height: "tableHeaderHeight", letterSpacing: "0.025em", position: "sticky", px: [0, 2], textTransform: "uppercase", top: 0, width: "100%", zIndex: "header" },
...
var VirtualRow = react_1.memo(function (_a) {
    ...
    return (react_1.default.createElement(TableViewItem_1.default, { item: item, selected: selectedIds.includes(assetId), shiftPressed: shiftPressed, style: rowStyle }));
...
var TableView = react_1.forwardRef(function (props, ref) {
    ...
    return (react_1.default.createElement(Box_1.default, { height: height, width: width },
        react_1.default.createElement(react_window_1.FixedSizeList, { className: "sanity-media-custom-scrollbar", height: height, innerElementType: innerElementType, itemData: {
                items: items,
                selectedIds: selectedIds,
                shiftPressed: shiftPressed,
            }, itemCount: itemCount, itemSize: parseInt(tableRowHeight), onItemsRendered: onItemsRendered, ref: ref, width: width }, VirtualRow)));
});
