...
var Card_1 = __importDefault(require("../Item/Card"));
...
var VirtualCell = react_1.memo(function (_a) {
    ...
    return (react_1.default.createElement(Card_1.default, { item: item, focused: focusedId === assetId, key: "grid-" + assetId, selected: selectedIds.includes(assetId), shiftPressed: shiftPressed, style: cellStyle }));
});
var CardView = react_1.forwardRef(function (props, ref) {
    ...
    return (react_1.default.createElement(react_window_1.VariableSizeGrid, { className: "custom-scrollbar", columnCount: columnCount, columnWidth: function () { return cardWidth; }, height: height, innerElementType: innerElementType, itemData: {
