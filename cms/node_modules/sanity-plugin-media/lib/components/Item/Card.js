...
var CardItem = function (props) {
    ...
    var handleAssetPick = function () {
        if (!shiftPressed) {
            dispatch(assets_1.assetsPickClear());
            dispatch(assets_1.assetsPick(asset._id, true));
        }
        else {
            dispatch(assets_1.assetsPick(asset._id, !picked));
        }
    };
    var handleDialogConflicts = function (e) {
        e.stopPropagation();
        dispatch(dialog_1.dialogShowConflicts(asset));
    };
    ...
    return (react_1.default.createElement(Box_1.default, { alignItems: "center", bg: picked ? 'overlayCard' : 'none', borderRadius: "4px", display: "flex", justifyContent: "center", onClick: handleAssetPick, onDoubleClick: selected ? undefined : handleSelect, p: 2, position: "relative", style: style, transition: "background 250ms", userSelect: "none" },
        react_1.default.createElement(ResponsiveBox_1.default, { aspectRatio: 4 / 3 },
            ...
            selected && (react_1.default.createElement(Box_1.default, { bottom: 0, position: "absolute", right: 0, textColor: "white" },
                react_1.default.createElement(Button_1.default, { icon: io_1.IoIosCheckmarkCircle({ size: 20 }), pointerEvents: "none" }))),
            updating && (react_1.default.createElement(Box_1.default, { alignItems: "center", display: "flex", fontSize: 3, justifyContent: "center", left: 0, position: "absolute", size: "100%", textColor: "white", top: 0 },
                react_1.default.createElement(Spinner_1.default, null))),
            focused && onSelect && !selected && (react_1.default.createElement(Box_1.default, { bottom: 0, onClick: handleDialogConflicts, position: "absolute", right: 0, textColor: "white" },
                react_1.default.createElement(Button_1.default, { icon: io_1.IoIosCheckmarkCircleOutline({ size: 20 }), onClick: handleSelect }))),
            errorCode && (react_1.default.createElement(Box_1.default, { bottom: 0, color: "white", position: "absolute", right: 0, top: 0 },
                react_1.default.createElement(Button_1.default, { icon: io_1.IoIosAlert({ size: 20 }), onClick: handleDialogConflicts, variant: "danger" }))))));
};
exports.default = react_1.memo(CardItem);
