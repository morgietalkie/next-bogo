...
function withRedux(ComposedComponent) {
    ...
    return _a = /** @class */ (function (_super) {
            ...
            function WithReduxComponent(props) {
                ...
                // TODO: correctly type
                // @ts-ignore
                var filters = config_1.getFilters(props === null || props === void 0 ? void 0 : props.document);
                _this.store = redux_1.createStore(modules_1.rootReducer, {
                    assets: __assign(__assign({}, assets_1.initialState), { filter: filters[0], filters: filters }),
                    // TODO: correctly type
                    // @ts-ignore
